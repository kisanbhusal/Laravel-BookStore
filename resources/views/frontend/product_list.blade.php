                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{asset('frontend/assets/img/categori/product6.png')}}" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{asset('frontend/assets/img/categori/product2.png')}}" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{asset('frontend/assets/img/categori/product5.png')}}" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{asset('frontend/assets/img/categori/product1.png')}}" alt="" class="img-fluid">
                                    <h3> <a href="single-product.html">Memory foam filling cotton Slow rebound pillows</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{asset('frontend/assets/img/categori/product4.png')}}" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{asset('frontend/assets/img/categori/product3.png')}}" alt="" class="img-fluid">
                                    <h3> <a href="single-product.html">Sleeping orthopedic sciatica Back Hip Joint Pain relief</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
